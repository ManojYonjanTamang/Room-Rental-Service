  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      ...
      <div>
        ...
        />
        {formik.touched.rent && formik.errors.rent && <div>{formik.errors.rent}</div>}
      </div>
      ...
      <div>
        ...
        />
        {formik.touched.latitude && formik.errors.latitude && <div>{formik.errors.latitude}</div>}
      </div>
      ...
      <div>
        ...
        />
        {formik.touched.longitude && formik.errors.longitude && <div>{formik.errors.longitude}</div>}
      </div>
      ...
      {isManualEntry && <LeafletMap onMapClick={(coords) => setCoordinates(coords)} />}
